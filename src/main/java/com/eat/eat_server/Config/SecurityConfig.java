...
import com.eat.eat_server.Authentication.Jwt.JwtAuthorizationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .addFilter(new JwtAuthorizationFilter(authenticationManager(),  jwtTokenProvider(), principalDetailService))  // AuthenticationManager
...
//        configuration.addAllowedOrigin("https://rainbow-letter.com");
